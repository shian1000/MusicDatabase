...
from menu.song_actions.edit_songs_menu import edit_songs_menu
from utils.database.database_getter import extract_db_object_info


def song_actions(songs_objects, sessions):
    songs_list = extract_db_object_info(songs_objects, "artist, title")

    action_map = {
        "Edit": lambda: edit_songs_menu(songs_objects, sessions),
